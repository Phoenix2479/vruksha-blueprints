...
import { Globe, RefreshCw, CheckCircle, XCircle, Plus, Loader2 } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold">Language Support</h1>
                <p className="text-sm text-gray-500">Multi-language and localization</p>
              </div>
            </div>
            ...
            {tabs.map(tab => (
              <button key={tab} onClick={() => setActiveTab(tab)}
                className={`py-4 px-1 border-b-2 font-medium text-sm ${
                  activeTab === tab ? 'border-emerald-500 text-emerald-600' :
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <StatsCard label="Service" value="Language Support" />
      </div>
