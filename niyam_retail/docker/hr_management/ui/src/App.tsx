...
import { Users, RefreshCw, CheckCircle, XCircle, Plus, Loader2 } from 'lucide-react'
...
export default function App() {
  ...
  const tabs = ["Dashboard","Employees"]
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Employee and human resources management</p>
              </div>
            </div>
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <StatsCard label="Service" value="HR Management" />
      </div>
    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <div className="bg-white rounded-xl shadow-sm border p-6">
          ...
          <EntityForm
            fields={[{"name":"name","label":"Name","type":"text","required":true},{"name":"email","label":"Email","type":"email","required":false},{"name":"role","label":"Role","type":"select","options":["Manager","Staff","Admin","Cashier"]},{"name":"status","label":"Status","type":"badge"}]}
