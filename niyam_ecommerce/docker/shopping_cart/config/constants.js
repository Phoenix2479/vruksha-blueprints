...
// Cart abandonment timeout in milliseconds (default: 24 hours)
const CART_ABANDONMENT_TIMEOUT_MS = parseInt(process.env.CART_ABANDONMENT_TIMEOUT_MS) || 24 * 60 * 60 * 1000;
