...
import { Shield, RefreshCw, CheckCircle, XCircle, Plus, Loader2 } from 'lucide-react'
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">User authentication and sessions</p>
              </div>
            </div>
            ...
            {tabs.map(tab => (
              <button key={tab} onClick={() => setActiveTab(tab)}
                className={`py-4 px-1 border-b-2 font-medium text-sm ${
                  activeTab === tab ? 'border-slate-500 text-slate-600' :
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <StatsCard label="Service" value="Authentication" />
      </div>
