...
router.get('/healthz', (_req, res) => res.json({ status: 'ok', service: 'accounting_payroll', timestamp: new Date().toISOString() }));
...
router.get('/stats', (_req, res) => res.json({ service: 'accounting_payroll', uptime: process.uptime(), version: '0.1.0' }));
