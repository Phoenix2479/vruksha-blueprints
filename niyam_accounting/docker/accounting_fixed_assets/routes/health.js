...
router.get('/healthz', (_req, res) => res.json({ status: 'ok', service: 'accounting_fixed_assets', timestamp: new Date().toISOString() }));
...
router.get('/stats', (_req, res) => res.json({ service: 'accounting_fixed_assets', uptime: process.uptime(), version: '0.1.0' }));
