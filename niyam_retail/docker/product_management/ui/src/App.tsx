...
import { Box, RefreshCw, CheckCircle, XCircle, Plus, Loader2 } from 'lucide-react'
...
export default function App() {
  ...
  const tabs = ["Dashboard","Categories","Variants"]
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Product catalog, categories, and variants</p>
              </div>
            </div>
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <StatsCard label="Service" value="Product Management" />
      </div>
    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <div className="bg-white rounded-xl shadow-sm border p-6">
          ...
          <EntityForm
            fields={[{"name":"name","label":"Category Name","type":"text","required":true},{"name":"parent_id","label":"Parent Category","type":"text"}]}
      ...
      <DataTable
        columns={["name","parent_id","created_at"]}
        data={items}
        isLoading={isLoading}
      />
    </div>
...
function VariantView() {
  ...
  const createMutation = useMutation({
    mutationFn: (data: any) => api.post('/products/:id/variants', data),
    onSuccess: () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {showForm && (
        <div className="bg-white rounded-xl shadow-sm border p-6">
          <h3 className="text-lg font-medium mb-4">New Variant</h3>
          <EntityForm
            fields={[{"name":"sku","label":"SKU","type":"text","required":true},{"name":"price_override","label":"Price Override","type":"number"}]}
            onSubmit={(data) => createMutation.mutate(data)}
            onCancel={() => setShowForm(false)}
            isLoading={createMutation.isPending}
          />
