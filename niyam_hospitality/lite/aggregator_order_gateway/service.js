/**
 * Aggregator Order Gateway Service - Niyam Hospitality (Max Lite)
...
const SERVICE_NAME = 'aggregator_order_gateway';
...
app.get('/api/aggregator_order_gateway', (req, res) => {
  res.json({ success: true, message: 'Stub endpoint - implement business logic', items: [] });
});

app.post('/api/aggregator_order_gateway', (req, res) => {
