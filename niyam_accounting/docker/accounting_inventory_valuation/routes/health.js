// Health, readiness, and stats endpoints for accounting_inventory_valuation
...
router.get('/healthz', (req, res) =>
  res.json({ status: 'ok', service: 'accounting_inventory_valuation', timestamp: new Date().toISOString() }));
...
router.get('/stats', (req, res) =>
  res.json({ service: 'accounting_inventory_valuation', uptime: process.uptime(), version: '0.1.0' }));
